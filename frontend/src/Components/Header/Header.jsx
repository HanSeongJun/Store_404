                    ...
                    {user ? (
                        <>
                            ...
                            <div className="Header-User-Menu-Member" data-dropdown>
                                <button className="Header-User-Menu-Button" onClick={handleUserMenuClick}>
                                    {user.name}<span>▼</span>
                                </button>
                                {isUserMenuOpen && (
                                    <div className="Header-User-Menu-Member-Dropdown">
                                        <div className="Header-User-Menu-Member-Dropdown-Info">
                                            <div className="Header-User-Menu-Member-Dropdown-Hello">
                                                안녕하세요,
                                            </div>
                                            <div className="Header-User-Menu-Member-Dropdown-Member">
                                                {user.name}님
                                            </div>
                                        </div>
                                        <button className="Header-User-Menu-Logout-Button" onClick={handleLogout}>
                                            로그아웃
                                        </button>
                                    </div>
                                )}
